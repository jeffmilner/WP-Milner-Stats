<?php
/**
 * REST API endpoints for Milner Stats.
 *
...
class WMS_REST_API {
	...
	private function get_client_ip(): string {
		...
		foreach ( $candidates as $key ) {
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- validated by filter_var( FILTER_VALIDATE_IP ), which is stricter than sanitize_text_field for IP addresses.
